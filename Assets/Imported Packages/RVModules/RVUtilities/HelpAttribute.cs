...
public class HelpDrawer : PropertyDrawer
{
    ...
    public override float GetPropertyHeight(SerializedProperty prop, GUIContent label)
    {
        ...
        if (multilineAttribute != null && prop.propertyType == SerializedPropertyType.String) addedHeight = 48f;
    ...
    public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label)
    {
        ...
        // todo edit by me
        helpPos.xMin += EditorGUI.indentLevel * 15;

        if (multiline != null) helpPos.height -= addedHeight;
