    ...
    public class RTSCamera : MonoBehaviour
    {
        ...
        */
            ...
            transform.position = new Vector3(transform.position.x,
                transform.position.y - (transform.position.y - (1 + CurrentZoom))*0.1f, transform.position.z);

            float x = transform.eulerAngles.x - (transform.eulerAngles.x - (15 + CurrentZoom*ZoomRotation))*0.1f;
